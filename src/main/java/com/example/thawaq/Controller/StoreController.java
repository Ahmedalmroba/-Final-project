...
public class StoreController {
    ...
    @GetMapping("/get-restaurants-you-like")
    public ResponseEntity findRestaurantYouLike(@AuthenticationPrincipal User user){
        return ResponseEntity.status(200).body(storeService.getRestaurantsYouLike(user));
    }

    @GetMapping("/get-cafes-you-like")
    public ResponseEntity findCafesYouLike(@AuthenticationPrincipal User user){
        return ResponseEntity.status(200).body(storeService.getCafesYouLike(user));
    }

    @GetMapping("/get-restaurants-you-may-like")
    public ResponseEntity findRestaurantYouMayLike(@AuthenticationPrincipal User user){
        return ResponseEntity.status(200).body(storeService.getRestaurantYouMayLike(user));
    }

    @GetMapping("/get-cafes-you-may-like")
    public ResponseEntity findCafesYouMayLike(@AuthenticationPrincipal User user){
        return ResponseEntity.status(200).body(storeService.getCafesYouMayLike(user));
    }
